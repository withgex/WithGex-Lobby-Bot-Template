...
module.exports = {
  name: 'random',
  description: 'Seleccione\ un cosmético aleatorio.',
  category: 'cosmetic',
  aliases: ['r'],
  usage: '<cosmetic>',
  example: 'skin',
  ...
  run: async (client, bot, message, args, getCosmetic) => {
    ...
    switch (cosmetic.toLowerCase()) {
      ...
      default: {
        return error2('Cosmético no dado válido.\nPor favor, elija entre `skin`,` mochila`, `baile`, `pico`, `emoji`', message);
      }
    }
    ...
    success3(`Equipado **${cc.name}** [**${cc.id}**].`, message);
  }
}